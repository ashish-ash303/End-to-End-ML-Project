...
@dataclass # use Only When We only Define variable 
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self): # It reads the data from various Soureces
        ...
        try:
            ...
            return
            (
            self.ingestiion_config.train_data_path,
